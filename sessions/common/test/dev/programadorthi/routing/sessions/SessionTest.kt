...
class SessionTest {
    @Test
    fun shouldHaveASessionWhenLoggedIn() =
        runTest {
            val job = Job()
    ...
    @Test
    fun shouldUpdateCurrentSessionWhenLoggedIn() =
        runTest {
            val job = Job()
            var userSession: UserSession? = null
    ...
    @Test
    fun shouldClearSessionWhenLoggedOut() =
        runTest {
            val job = Job()
            var userSession: UserSession? = null
    ...
    @Test
    fun shouldNestedRoutingGetParentSessionWhenHavingNestedRouting() =
        runTest {
            // GIVEN
            val job = Job()
            var userSession: UserSession? = null
    ...
    @Test
    fun shouldScopedSessionNotBeSharedWithParentWhenHavingNestedRouting() =
        runTest {
            // GIVEN
            val job = Job()
            ...
            assertEquals(
                "Session data for type " +
                    "`class dev.programadorthi.routing.sessions.UserSession " +
                    "(Kotlin reflection is not available)` was not registered",
                exception?.message,
            )
        }
}
