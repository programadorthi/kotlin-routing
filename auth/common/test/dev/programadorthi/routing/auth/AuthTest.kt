...
class AuthTest {
    ...
    @Test
    fun shouldNeverHandleARouteWhenAuthorizationIsRequired() =
        runTest {
            val job = Job()
    ...
    @Test
    fun shouldHandleARouteWithNullPrincipalWhenAuthorizationIsRequired() =
        runTest {
            val job = Job()
    ...
    @Test
    fun shouldNeverAuthenticateWhenAuthenticationValidateReturnsNull() =
        runTest {
            val job = Job()
            var exception: Throwable? = null
    ...
    @Test
    fun shouldAskForChallengeAndBeAuthorizedWhenChallengeHasApprovedStatus() =
        runTest {
            val job = Job()
            var principal: UserIdPrincipal? = UserIdPrincipal(name = "default value")
    ...
    @Test
    fun shouldAskForChallengeAndBeNotAuthorizedWhenChallengeHasDeniedStatus() =
        runTest {
            val job = Job()
            var exception: Throwable? = null
    ...
    @Test
    fun shouldAskForChallengeAndRedirectToAuthenticationWhenChallengeDoesARedirection() =
        runTest {
            val job = Job()
            var exception: Throwable? = null
    ...
    @Test
    fun shouldAnswerChallengeBlockingWhenWaitingToSolveIt() =
        runTest {
            val job = Job()
    ...
    @Test
    fun shouldParentManagerAuthenticationWhenHavingNestedRouting() =
        runTest {
            val job = Job()
            var exception: Throwable? = null
    ...
    @Test
    fun shouldParentNeverUseChildAuthenticationWhenHavingNestedRouting() =
        runTest {
            val job = Job()
            ...
            assertEquals(
                "Authentication configuration with the name profile-config " +
                    "was not found. Make sure that you install Authentication plugin " +
                    "before you use it in Routing",
                exception.message,
            )
        }

    @Test
    fun shouldChildHasHisOwnerAuthenticationWhenHavingNestedRouting() =
        runTest {
            val job = Job()
            var principal: UserIdPrincipal? = UserIdPrincipal(name = "default value")
    ...
    @Test
    fun shouldParentAndChildHasHisOwnerAuthenticationWhenHavingNestedRouting() =
        runTest {
